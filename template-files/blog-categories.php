...
/**
 * Categories template
 * Example template file populated with MarkupBlog output and additional custom code for the Blog Categories
 *
 */
    ...
    $subNav = $blogOut->renderNav($page->title, $page->children, $page); 
    ...
    $content .= $blogOut->renderCategories($page->children, $limit);//children => the individual category pages
