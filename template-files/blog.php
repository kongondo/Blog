...
/**
 * Blog Home template
 * Example template file populated with MarkupBlog output and additional custom code for the Blog Home Page
 *
 */
    ...
    $subNav = $blogOut->renderNav($categories->title, $categories->children);
