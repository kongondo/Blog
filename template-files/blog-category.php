...
/**
 * Category template
 * Example template file populated with MarkupBlog output and additional custom code for a Blog Category
 *
 */
    ...
    $subNav = $blogOut->renderNav($page->parent->title, $page->siblings, $page);
    ...
    $content .= $page->blog_body . $blogOut->renderPosts($posts, true);
